...
const Features = () => {
  ...
  const features = [
    {
      title: 'Chuẩn bị sẵn sàng những kế hoạch hẹn hò và gửi nó ngay tới đối phương',
      image: Feature_1,
      bgHover: Bg_Feature
    },
    {
      title: 'Vô vàn những ý tưởng hẹn hò được mọi người đề xuất trên nền tảng xã hội',
      image: Feature_2,
      bgHover: Bg_Feature
    },
    {
